...
let famousPeople = [
    ...
    for (let i = 0; i < famousCard.length; i++) { 
        famousCard[i].addEventListener("click", function(e){
            ...
            e.currentTarget.classList.add("border"); // adds border to target
            borderedElement = e.currentTarget  // defines bE for the above conditionals
            inputField.focus();
            // console.log("testing");
        })
    }
    ...
    inputField.addEventListener("input", function() {  
        document.querySelector(".border p").innerHTML = inputField.value;
    });
